...
namespace hongtan.Models
{
    ...
    partial void DeleteBidModel(BidModel instance);
		...
		public System.Data.Linq.Table<BidModel> BidModel
		{
			get
			{
    ...
    partial void OnVoteStatusChanging(int value);
    partial void OnVoteStatusChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_VoteStatus", DbType="Int NOT NULL")]
